...
public class MagicPay {
	...
	public void addMagicPayDetails(int CompanyId, int CustomerId, String TransactionId, Object PaymentGatewayTransactionId,
		...
		try {
			if (_Connection != null) {
				...
				while (_ResultSet.next()) {
					...
					_MagicPay.setTransactionId(_ResultSet.getString("TransactionId"));
